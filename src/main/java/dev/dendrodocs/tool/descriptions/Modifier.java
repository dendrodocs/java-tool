 ...
 * DendroDocs dotnet and that have an equivalent in Java. Modifiers that only exist in C# (for
 * example 'async') or Java (like 'strictfp') are not included, but could be in the future. Values
 * (bitmasks) are taken from <code>DendroDocs.Shared/Modifier.cs</code>.
 */
